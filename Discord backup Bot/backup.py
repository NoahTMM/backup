...
print(Fore.CYAN + '                                                                                                                                                              ')
print(Fore.CYAN + '   _____   _                                _     _____                 _                       _____          _            __                                ')
print(Fore.CYAN + '  (_____) (_) ____                _        (_)   (_____)               (_) _                   (_____)        (_)_     _   |_ |                               ')
print(Fore.CYAN + '  (_)  (_) _ (____)   ___   ___  (_)__   __(_)   (_)__(_)  ____    ___ (_)(_)  _   _  ____     (_)__(_)  ___  (___)   |_|    | |                              ')
print(Fore.CYAN + '  (_)  (_)(_)(_)__  _(___) (___) (____) (____)   (_____)  (____) _(___)(___)  (_) (_)(____)    (_____)  (___) (_)      _     | |                              ')
print(Fore.CYAN + '  (_)__(_)(_) _(__)(_)___ (_)_(_)(_)   (_)_(_)   (_)__(_)( )_( )(_)___ (_)(_) (_)_(_)(_)_(_)   (_)__(_)(_)_(_)(_)_    |_|   _| |                              ')
print(Fore.CYAN + '  (_____) (_)(____) (____) (___) (_)    (____)   (_____)  (__)_) (____)(_) (_) (___) (____)    (_____)  (___)  (__)        |__|         ▀▄▀▄▀▄ BY RVID_ ▄▀▄▀▄▀')
print(Fore.CYAN + '                                                                                     (_)                                                                      ')
print(Fore.CYAN + '                                                                                     (_)                                                                      ')
print(Fore.CYAN + '                                                                                                                                                              ')
print(Fore.CYAN + '                                                                                                                                                              ')
...
def save_friends():
    ...
    for friend in friends.json():
        if friend['type'] == 1:
            ...
            sys.stdout.write(Fore.WHITE + (username))
        ...
        for channel in channels.json():
            if channel['type'] == 0:
                ...
                if invite.status_code == 403:
                    attempts += 1
                    sys.stdout.write(Fore.YELLOW + 'Discord Server: %s | Channel ID: %s | Retrying . . .\n' % (server_name, channel_id))
                    if attempts == 5:
                        sys.stdout.write(Fore.RED + '%s has a Vanity URL.\n' % (server_name))
                    ...
                    sys.stdout.write(Fore.RED + 'Rate limited.\n')
                    time.sleep(9)
                
                else:
                    invite_url = 'https://discord.gg/%s' % (str(invite.json()['code']))
                    sys.stdout.write(Fore.WHITE + 'Discord Server: %s | Invite Link: %s\n' % (server_name, invite_url))
                    with open('Discord Servers.txt', 'a', encoding = 'UTF-8') as f:
...
def add_friends():
    ...
    if os.path.exists('Discord Friends.txt'):
            ...
            for line in f.readlines():
                while True:
                    try:
                        ...
                        sys.stdout.write(Fore.RED + 'Invalid syntax at line: %s\n' % (line))
                        break
                    ...
                    if add.status_code == 429:
                        ...
                        sys.stdout.write(Fore.WHITE + 'Sent Friend Request to: %s\n' % (user_name))
                        added_friends += 1
                        break
                    elif add.status_code == 400:
                        sys.stdout.write(Fore.RED + 'User has disabled Friend Requests: %s\n' % (user_name))
                        break
                    elif add.status_code == 403:
                        sys.stdout.write(Fore.RED + 'Verify your Discord account.\n')
                        break
                    else:
                        sys.stdout.write(Fore.RED + 'Error: %s\n' % (add.text))
                        break
        ...
        sys.stdout.write(Fore.RED + '> You have not saved any friends.\n\n')
...
def join_servers():
    ...
    if os.path.exists('Discord Servers.txt'):
                ...
                while True:
                    try:
                        ...
                        if 'Vanity URL' in line:
                            sys.stdout.write(Fore.RED + 'Server has a Vanity URL.\n')
                            break
                        else:
                    ...
                    if join.status_code == 429:
                        ...
                        sys.stdout.write(Fore.GREEN + 'Successfully Joined: %s\n' % (server_name))
                        joined_servers += 1
                        break
        ...
        sys.stdout.write(Fore.RED + '> You have not saved any servers.\n\n')
...
while True:
    ...
    if connect.status_code == 200:
        option = str(input(Fore.CYAN + '[1] Save Friends\n[2] Save Servers\n\n[3] Add Friends\n[4] Join Servers\n\n> Select an option: '))
        sys.stdout.write('\n')
        if option == '1' or option == 'Save Friends':
            ...
            sys.stdout.write(Fore.RED + '> Invalid option.\n\n')

    else:
        sys.stdout.write(Fore.RED + '> Could not find token in the code or your Discord token is invalid :c \n')
        token = str(input(Fore.GREEN +'> Here you can also enter your Discord token :D : '))
        sys.stdout.write('\n')
